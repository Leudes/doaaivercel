...
export interface ApiCampanhaCampanha extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    data_fim: Attribute.Date;
    data_inicio: Attribute.Date;
    descricao: Attribute.Text;
    foto: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    local_arrecadacao: Attribute.Text;
...
export interface ApiInstituicaoInstituicao extends Schema.CollectionType {
  collectionName: 'instituicaos';
  info: {
    description: '';
    displayName: 'Instituicao';
    pluralName: 'instituicaos';
  ...
  attributes: {
    ...
    nome: Attribute.String;
    publishedAt: Attribute.DateTime;
    solicitacaos: Attribute.Relation<
      'api::instituicao.instituicao',
      'oneToMany',
...
export interface ApiSolicitacaoSolicitacao extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    data_disponivel: Attribute.Date;
    descricao: Attribute.Text;
    foto: Attribute.Media<'images' | 'videos' | 'audios' | 'files'>;
    instituicao: Attribute.Relation<
      'api::solicitacao.solicitacao',
      'manyToOne',
      'api::instituicao.instituicao'
    >;
    publishedAt: Attribute.DateTime;
    status: Attribute.Enumeration<['pendente', 'aceito', 'recusado', 'doado']>;
    titulo: Attribute.String;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::solicitacao.solicitacao',
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    foto_perfil: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    instituicao: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::instituicao.instituicao'
